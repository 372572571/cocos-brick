...
declare namespace wx {
	...
	export function onShow(callback: { success: any, fail: any });
	export function onHide(callback: any);
	export function exitMiniProgram(callback: { success: any, fail: any })
	 ...
	 * @param {*} callback
	 */
	export function onTouchStart(callback: any)
	 ...
	 */
	export function getSystemInfo(callback: Icallback): void
	 ...
	 * @param {() => void} callback
	 */
	export function onMessage(callback: (res) => void): void

	declare interface IgetFriendCloudStorage extends BaseOptions {
		keyList: string | Array<string>
	}

	export function getOpenDataContext(): { postMessage: (res: any) => any }

	export function getFriendCloudStorage(obj: IgetFriendCloudStorage): Promise<any>

	declare interface IsetUserCloudStorage extends BaseOptions {
		KVDataList: Array<any>
	}
	export function setUserCloudStorage(IsetUserCloudStorage: IsetUserCloudStorage)
 ...
 * 小程序启动参数
 *
 * @interface StartupParameter
 */
declare interface IStartupParameter {
	scene: number  	// 场景值
	query: any  	//启动参数
